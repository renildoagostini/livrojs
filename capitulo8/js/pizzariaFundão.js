...
frm.inDetalhes.addEventListener("focus", () => {//Quando o campo recebe o foco
    if(frm.rbPizza.checked){ //se radio buttom estiver marcado
        const pizza = frm.inPizza.value //obtém value do item selecionado
        //uso do operador ternario, para indicar o número de sabores
        const num = pizza == "media" ? 2 : pizza == "grande" ? 3 : 4
        //atributo placeholder exibe uma dica de preenchimento de campo
...
frm.addEventListener("submit", (e) => {
    ...
    if(frm.rbPizza.checked){
        const num = frm.inPizza.selectedIndex; //obtém o número de item selecionado
